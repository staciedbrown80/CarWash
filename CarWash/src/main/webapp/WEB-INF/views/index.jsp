			...
			<div class="dashboard-ecommerce">
				<div class="container-fluid dashboard-content ">
					...
					<div class="ecommerce-widget">
						...
						<div class="col-xl-3 col-lg-6 col-lg-6 col-sm-12 col-12">
						
							<div class="responsive">
									<div class="gallery">
									<a href="itemdetail?type=1">
									    <button type="submit">
											<img src="resources/images/1DELUXE_1-31.PNG" alt="Deluxe Wash" width="250" height="330">
										</button>
											</a>
						...
						<div class="col-xl-3 col-lg-6 col-lg-6 col-sm-12 col-12">
							<div class="responsive">
									...
									<a href="itemdetail?type=2">
									    <button type="submit">
											<img src="resources/images/2ULTIMATE_1-31.PNG" alt="Ultimate Wash" width="250" height="380">
										</button>
											</a>
										<!-- ->div class="desc">CLICK HERE</div>-->
									</div>
						...
						<div class="col-xl-3 col-lg-6 col-lg-6 col-sm-12 col-12">
							<div class="responsive">
									...
									<a href="itemdetail?type=3">
									    <button type="submit">
											<img src="resources/images/3BRILLIANCE_1-31.PNG" alt="Brilliance Wash" width="250" height="420">
										</button>
											</a>
										<!-- div class="desc">CLICK HERE</div>-->
									</div>
						...
						<div class="col-xl-3 col-lg-6 col-lg-6 col-sm-12 col-12">
							<div class="responsive">
									...
									<a href="itemdetail?type=4">
									    <button type="submit">
											<img src="resources/images/4THEWORKS_1-31.PNG" alt="The Works Wash" width="250" height="450">
										</button>
											</a>
										<!-- ->div class="desc">CLICK HERE</div>-->
									</div>
